...
export function EventCard({
  ...
  return (
    <article className="group flex min-h-[500px] flex-col overflow-hidden rounded-2xl border border-border bg-surface text-left shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 flex min-w-0 items-center gap-2 overflow-hidden whitespace-nowrap text-sm text-text-muted">
        ...
        <h3 className="mt-4 min-h-14 font-heading text-lg font-bold leading-7 text-text-main">
          {event.title}
        </h3>
